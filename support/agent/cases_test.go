...
// 	// set up sim
// 	rnd := rand.New(rand.NewSource(42))
// 	sim2 := agent.NewSim(ctx, t, newBlockStore, agent.SimConfig{
// 		Seed:             rnd.Int63(),
// 		CheckpointEpochs: 1000,
// 	})
// 	sim2.v = vm_test.NewVMWithSingletons(ctx,  t, sim2.blkStore)

// 	// create miners
// 	workerAccounts := vm_test2.CreateAccounts(ctx, t, sim2.GetVM(), minerCount, initialBalance, rnd.Int63())
// 	sim.AddAgent(agent2.NewMinerGenerator(
// 		workerAccounts,
// 		agent.MinerAgentConfig{
// 			PrecommitRate:    2.0,
// 			FaultRate:        0.00001,
...
// 	agent.AddDealClientsForAccounts(sim2, clientAccounts, rnd.Int63(), agent.DealClientConfig{
// 		DealRate:         .05,
// 		MinPieceSize:     1 << 29,
// 		MaxPieceSize:     32 << 30,
// 		MinStoragePrice:  big.Zero(),
